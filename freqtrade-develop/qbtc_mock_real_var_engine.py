...
def run_server():
    server = HTTPServer(('localhost', 14501), QBTCMockHandler)
    server.start_time = time.time()
    server.request_count = 0
    
    print(f"🌌 {service_name} running on port 14501")
    print(f"📊 Health endpoint: http://localhost:14501/health")
