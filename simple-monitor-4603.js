 ...
 * Versión simplificada para monitoreo básico
 */
...
// Iniciar servidor
app.listen(port, () => {
    console.log(` Simple Quantum Monitor running on port ${port}`);
    console.log(`[DATA] Dashboard: http://localhost:${port}`);
    console.log(` API Status: http://localhost:${port}/api/system-status`);
});

// Manejar cierre graceful
process.on('SIGINT', () => {
    console.log('\n Shutting down Simple Quantum Monitor...');
    process.exit(0);
});