...
class LeonardoOrderExecutor extends EventEmitter {
    ...
    /**
     * Genera datos de mercado determinísticos
     * @private
     */
    ...
    async _executeSimulatedOrder(orderParams) {
        ...
        // Aplicar ventaja temporal lunar determinística
    ...
    /**
     * Genera posiciones determinísticas
     * @private
     */
    _generateSimulatedPositions() {
        ...
        // Generar un número determinístico de posiciones (0-2)
