...
router.get('/', async (req, res) => {
  try {
    ...
    logger.error('[ERROR] Error fetching quantum options:', error);
...
router.get('/:symbol', async (req, res) => {
  try {
    ...
    logger.error(`[ERROR] Error fetching quantum option ${req.params.symbol}:`, error);
...
router.get('/quantum-opportunities', async (req, res) => {
  try {
    ...
    logger.error('[ERROR] Error identifying quantum opportunities:', error);
...
router.get('/quantum-greeks/:symbol', async (req, res) => {
  try {
    ...
    logger.error(`[ERROR] Error calculating quantum Greeks for ${req.params.symbol}:`, error);
