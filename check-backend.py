#!/usr/bin/env python3
"""
VERIFICADOR DEL BACKEND REAL QBTC
Script para verificar el estado del backend y su base de datos.
"""
...
def check_backend_status():
    """Verifica el estado del backend real."""
    print("=" * 60)
    print("[SEARCH] VERIFICADOR DEL BACKEND REAL QBTC")
    print("=" * 60)
    
    try:
        # Conectar a la base de datos
        conn = sqlite3.connect("backend_real.db")
        cursor = conn.cursor()
        ...
        print(f"[DATA] Total de registros en base de datos: {total_records}")
        ...
        print(f"\n[DATA] Estadísticas por servicio:")
        print("-" * 60)
