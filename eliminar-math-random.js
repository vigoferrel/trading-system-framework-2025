...
function processFile(filePath) {
    try {
        ...
        if (replacements > 0) {
            ...
            console.log(`[OK] ${filePath}: ${replacements} reemplazos realizados`);
            return replacements;
        } else {
...
function processDirectory(dirPath, extensions = ['.js', '.html']) {
    ...
    console.log(`[RELOAD] Total de reemplazos: ${totalReplacements}`);
    console.log(`[OK] Eliminación de PHYSICAL_CONSTANTS.FIBONACCI_STRENGTH completada`);
...
function main() {
    ...
    console.log('[ENDPOINTS] Reemplazando con constantes físicas reales del sistema');
    ...
    console.log(`[UP] Sistema ahora usa ${result.totalReplacements} constantes físicas reales`);
    console.log(' Todas las simulaciones han sido eliminadas');
}
